...
public class ControlRun {
	...
	public static void main(String[] args) {
		...
		*/
		 ...
		 */
		/*
		System.out.print("구매할 할 과일을 입력 (수박/참외/복숭아) : ");
		String fruit = sc.next();
		
		// TODO: xx의 가격은 xxx원입니다.
		int price = 0;
		...
		if(price !=0)System.out.println(fruit+"의 가격은 "+ price+"원 입니다.");
		*/
