...
//		test1();
	...
	public static void test2() {
		...
		String str = "Hello";
		System.out.println("[1] " + str.equals("Hello")); //=> true
		System.out.println("[2] " + str.equals("Bye"));  // => false
		
		//	2) charAt : 문자열A.charAt(인덱스) : char => 해당 문자열에서 인덱스 위치의 문자값을 반환
		...
		System.out.println("[8] "+ str.contains("bb"));
...
//														=>	시작인덱스부터 끝까지
	...
	public static void test1() {
		String str1 = "apple"; //=> 상수풀에 저장
		String str2 = "apple"; //=> 상수풀에 저장
		
		// str1==str2 : 값비교? 주소값비교? => 주소값 비교
		...
		//   str1, "apple" 모두 상수풀의 같은곳에 저장되어 있어 true
		...
		System.out.println("값을 비교하고자할때(equals): "+ (str3.equals("apple")));
		...
		// System.identitiyHashCode(참조변수명) : System 클래스 내에서 해쉬값(주소값)을 확인하는 기능을 제공하는 메소드
