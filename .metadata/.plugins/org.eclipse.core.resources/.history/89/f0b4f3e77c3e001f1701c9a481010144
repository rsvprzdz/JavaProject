...
public class InetRun {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(iNet);	// PC 정보(호스트이름)/IP 주소" 출력			
			System.out.println("내 PC 정보 : "+iNet.getHostName());		// "내 PC 정보 : xxxx"
			System.out.println("내 IP 정보 : "+iNet.getHostAddress());	// "내 IP 정보 : x.x.x.x"
			System.out.println("내 PC 정보 : "+iNet.getAddress());
			...
			for(InetAddress n : iNet3) {
				...
				System.out.println("네이버 호스트명(서버명) : " + n.getHostAddress());
			}
